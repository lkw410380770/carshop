...
<div class="bigBox">
    <div class="titleNav">
        <span class="futitle">属性</span>
        <a href="/index.php/Admin/Attr/add/id/<?php echo ($type); ?>"><span class="addPlan btnright"><i class="iconfont icon-jiahao"></i>添加品牌</span></a>
    </div>
    <div class="info_table">
        <table class="layui-table layui-form" lay-even>
            ...
            <?php if(is_array($brandList)): $i = 0; $__LIST__ = $brandList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tree): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><?php echo ($tree["attr_name"]); ?></td>
                    <td>
                        <a onClick="" href="/index.php/Admin/Attr/edit/id/<?php echo ($tree["id"]); ?>" title="详情" class="tableBtn co1"><i
                                class="iconfont icon-xiangqingshuoming"></i>修改</a>
                        <a title="删除" href="/index.php/Admin/Attr/deletePlan/id/<?php echo ($tree["id"]); ?>" class="tableBtn co2"><i
