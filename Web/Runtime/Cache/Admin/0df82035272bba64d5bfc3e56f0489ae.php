...
<div class="bigBox">
  	 <div class="titleNav">
	  	<span class="futitle">商品分类</span>
	  	<a href="/index.php/Admin/Cate/add"><span class="addPlan btnright"><i class="iconfont icon-jiahao"></i>添加商品分类</span></a>
  	</div>
  <div class="info_table">
    <table class="layui-table layui-form" lay-even>
		  ...
		  <tbody>
		  <?php if(is_array($tree)): $i = 0; $__LIST__ = $tree;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tree): $mod = ($i % 2 );++$i;?><tr>
				<td><input type="checkbox" name="" lay-skin="primary"></td>
				<td><?php echo ($tree["id"]); ?></td>
				<td><?php if($tree["parentid"] != 0): ?>|<?php endif; echo str_repeat('-',$tree['level']*8); echo ($tree["name"]); ?></td>
				<td>
					<a onClick=""  href="/index.php/Admin/Cate/edit/id/<?php echo ($tree["id"]); ?>" title="详情"  class="tableBtn co1"><i class="iconfont icon-xiangqingshuoming"></i>修改</a>
					<a title="删除" href="/index.php/Admin/Cate/deletePlan/id/<?php echo ($tree["id"]); ?>" class="tableBtn co2" ><i class="iconfont icon-delete"></i>删除</a>
				</td>
