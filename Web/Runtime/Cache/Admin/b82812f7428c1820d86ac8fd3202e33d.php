...
<html><head>
    ...
    <link href="/Public/Admin/style/font-awesome.css" rel="stylesheet">
    <link href="/Public/Admin/style/weather-icons.css" rel="stylesheet">

    <!--Beyond styles-->
    <link id="beyond-link" href="/Public/Admin/style/beyond.css" rel="stylesheet" type="text/css">
    <link href="/Public/Admin/style/demo.css" rel="stylesheet">
    <link href="/Public/Admin/style/typicons.css" rel="stylesheet">
    <link href="/Public/Admin/style/animate.css" rel="stylesheet">
                        ...
                        <li>
                            <a class="login-area dropdown-toggle" data-toggle="dropdown">
                                <div class="avatar" title="View your public profile">
                                    <img src="/Public/Admin/images/adam-jansen.jpg">
                                </div>
                                <section>
...
<div class="row">
    <div class="col-lg-12 col-sm-12 col-xs-12">
	    ...
	    <!--Basic Scripts-->
    <script src="/Public/Admin/style/jquery_002.js"></script>
    <script src="/Public/Admin/style/bootstrap.js"></script>
    <script src="/Public/Admin/style/jquery.js"></script>
    <!--Beyond Scripts-->
    <script src="/Public/Admin/style/beyond.js"></script>
